 ...
 * @version 1.3.0
 */
@SuppressLint({ "SimpleDateFormat", "ClickableViewAccessibility" }) public class PullRefreshListView extends ListView{
    ...
    @SuppressLint("SimpleDateFormat") private String  lastUpdatedText;
    ...
    @SuppressLint("InflateParams") private void init(){
        ...
        headerContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.pull_refresh_header, null);
        ...
        pullToRefreshText = getContext().getString(R.string.pull_refresh_pull_to_refresh);
        releaseToRefreshText = getContext().getString(R.string.pull_refresh_release_to_refresh);
        refreshingText = getContext().getString(R.string.pull_refresh_refreshing);
        lastUpdatedText = getContext().getString(R.string.pull_refresh_last_updated);
    ...
    @SuppressLint("ClickableViewAccessibility") private void setHeaderPadding(int padding){
